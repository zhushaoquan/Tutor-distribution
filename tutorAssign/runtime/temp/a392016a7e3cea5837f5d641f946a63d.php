<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:82:"C:\wamp64\www\tutorAssign\public/../app/index\view\teacher_tutor\student_list.html";i:1479486114;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
                ...
                <div class="table-responsive">
                    ...
                    <nav>
                      <ul class="pagination" style="float: right;">
                          ...
                          <?php endif; if(($curPage > 3) AND ($curPage < $totalPage-2)): $__FOR_START_9017__=$curPage-2;$__FOR_END_9017__=$curPage+3;for($i=$__FOR_START_9017__;$i < $__FOR_END_9017__;$i+=1){ ?>
                              <li><a <?php if($i==$curPage) echo "class='active'"; ?> href="<?php echo url('/index/TeacherTutor/student_list/page/'.$i); ?>" ><?php echo $i; ?></a></li>
                            <?php } elseif(($curPage > $totalPage-3) AND ($totalPage > 5)): $__FOR_START_24320__=$totalPage-5;$__FOR_END_24320__=$totalPage;for($i=$__FOR_START_24320__;$i < $__FOR_END_24320__;$i+=1){ ?>
                              <li><a <?php if($i==$curPage) echo "class='active'"; ?> href="<?php echo url('index/TeacherTutor/student_list/page/'.$i); ?>" ><?php echo $i; ?></a></li>
                            <?php } elseif($totalPage > 5): $__FOR_START_8579__=1;$__FOR_END_8579__=6;for($i=$__FOR_START_8579__;$i < $__FOR_END_8579__;$i+=1){ ?>
                              <li><a <?php if($i==$curPage) echo "class='active'"; ?> href="<?php echo url('/index/TeacherTutor/student_list/page/'.$i); ?>" ><?php echo $i; ?></a></li>
                            <?php } else: $__FOR_START_8242__=1;$__FOR_END_8242__=$totalPage;for($i=$__FOR_START_8242__;$i < $__FOR_END_8242__;$i+=1){ ?>
                              <li><a <?php if($i==$curPage) echo "class='active'"; ?> href="<?php echo url('/index/TeacherTutor/student_list/page/'.$i); ?>" ><?php echo $i; ?></a></li>
