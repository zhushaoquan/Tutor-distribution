<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:101:"C:\wamp64\www\Tutor-distribution\tutorAssign\public/../app/index\view\teacher_tutor\student_list.html";i:1480930853;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
                ...
                <div class="table-responsive">
                    ...
                    <nav>
                      <ul class="pagination" style="float: right;">
                          ...
                          <?php endif; if(($curPage > 3) AND ($curPage < $totalPage-2)): $__FOR_START_2474__=$curPage-2;$__FOR_END_2474__=$curPage+3;for($i=$__FOR_START_2474__;$i < $__FOR_END_2474__;$i+=1){ ?>
                              <li><a <?php if($i==$curPage) echo "class='active'"; ?> href="<?php echo url('/index/TeacherTutor/student_list/page/'.$i); ?>" ><?php echo $i; ?></a></li>
                            <?php } elseif(($curPage > $totalPage-3) AND ($totalPage > 5)): $__FOR_START_1173__=$totalPage-5;$__FOR_END_1173__=$totalPage;for($i=$__FOR_START_1173__;$i < $__FOR_END_1173__;$i+=1){ ?>
                              <li><a <?php if($i==$curPage) echo "class='active'"; ?> href="<?php echo url('index/TeacherTutor/student_list/page/'.$i); ?>" ><?php echo $i; ?></a></li>
                            <?php } elseif($totalPage > 5): $__FOR_START_15436__=1;$__FOR_END_15436__=6;for($i=$__FOR_START_15436__;$i < $__FOR_END_15436__;$i+=1){ ?>
                              <li><a <?php if($i==$curPage) echo "class='active'"; ?> href="<?php echo url('/index/TeacherTutor/student_list/page/'.$i); ?>" ><?php echo $i; ?></a></li>
                            <?php } else: $__FOR_START_13439__=1;$__FOR_END_13439__=$totalPage;for($i=$__FOR_START_13439__;$i < $__FOR_END_13439__;$i+=1){ ?>
                              <li><a <?php if($i==$curPage) echo "class='active'"; ?> href="<?php echo url('/index/TeacherTutor/student_list/page/'.$i); ?>" ><?php echo $i; ?></a></li>
