                ...
                <div class="main-content" style="border-radius: 10px;padding: 20px;">
                        ...
                        <div style="display: inline-block;">
                            <form id="department-submit" action="<?php echo url('TeachingOfficeTutor/student_assign'); ?>" method="post">
                                <select class="form-control" name="department" style="display: inline-block; width: 200px">
                                    ...
                                    <option value="信息与计算科学系">信息与计算科学系</option>
                                    <option value="软件工程系">软件工程系</option>
                                    <option value="信息安全与网络工程系">信息安全与网络工程系</option>
                    ...
                    <div class="table-responsive">
                            ...
                            <tbody>
                                <?php
                                    ...
                                    echo '<tr>
                                        ...
                                        <input type="hidden" name="stu'.$i.'" value="'.$value['sid'].'">
                                        <select  name="'.$i.'" class="form-control" style="width: 200px; padding:5px 0; margin: 0; ">';

                                        foreach ($teacher as $value1) 
                                        {
                                            
                                            echo '<option value="'.$value1['workNumber'].'">'.$value1['workNumber'].'('.$value1['name'].')'.'</option>';
                                        }
                                     echo    '</select></td>
                                    </tr>';
                                    $i++;
                        ...
                        <div class="submit-area">
                            <button type="submit" class="btn btn-primary" style="width: 100px">确&nbsp;&nbsp;认</button>
                        </div>
