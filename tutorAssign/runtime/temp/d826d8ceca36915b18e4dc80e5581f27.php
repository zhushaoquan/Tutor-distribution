<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:110:"C:\wamp64\www\Tutor-distribution\tutorAssign\public/../app/index\view\department_head_tutor\match_setting.html";i:1480930909;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
                ...
                <div class="table-position">
                    ...
                    <nav>
                      <ul class="pagination" style="float: right;">
                          ...
                          <?php endif; if(($curPage > 3) AND ($curPage < $totalPage-2)): $__FOR_START_5553__=$curPage-2;$__FOR_END_5553__=$curPage+3;for($i=$__FOR_START_5553__;$i < $__FOR_END_5553__;$i+=1){ ?>
                            ...
                            <?php } elseif(($curPage > $totalPage-3) AND ($totalPage > 5)): $__FOR_START_12376__=$totalPage-5;$__FOR_END_12376__=$totalPage;for($i=$__FOR_START_12376__;$i < $__FOR_END_12376__;$i+=1){ ?>
                              <li><a <?php if($i==$curPage) echo "class='active'"; ?> href="<?php echo url('/index/index/DepartmentHeadTutor/matchSetting/page/'.$i); ?>" ><?php echo $i; ?></a></li>
                            <?php } elseif($totalPage > 5): $__FOR_START_315__=1;$__FOR_END_315__=6;for($i=$__FOR_START_315__;$i < $__FOR_END_315__;$i+=1){ ?>
                              <li><a <?php if($i==$curPage) echo "class='active'"; ?> href="<?php echo url('/index/index/DepartmentHeadTutor/matchSetting/page/'.$i); ?>" ><?php echo $i; ?></a></li>
                            <?php } else: $__FOR_START_19402__=1;$__FOR_END_19402__=$totalPage;for($i=$__FOR_START_19402__;$i < $__FOR_END_19402__;$i+=1){ ?>
                              <li><a <?php if($i==$curPage) echo "class='active'"; ?> href="<?php echo url('/index/index/DepartmentHeadTutor/matchSetting/page/'.$i); ?>" ><?php echo $i; ?></a></li>
                        ...
                        <tbody>
                            <?php if(is_array($teacher) || $teacher instanceof \think\Collection): $k = 0; $__LIST__ = $teacher;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$t): $mod = ($k % 2 );++$k;?>
                                <tr>
                                    ...
                                    <td style="text-align: center;"><?php echo $t['issue']['totalExper']; ?></td>
                                    <td style="text-align: center;"><?php echo $t['issue']['totalNatur']; ?></td>
                                    <td style="text-align: center;"><?php echo $t['issue']['nowExper']; ?></td>
                                    <td style="text-align: center;"><?php echo $t['issue']['nowNatur']; ?></td>
                                    <td>
