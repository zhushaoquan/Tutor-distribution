<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:90:"C:\wamp64\www\tutorAssign\public/../app/index\view\teaching_office_tutor\tutor_change.html";i:1479523851;}*/ ?>
<!DOCTYPE html>
<html>
                ...
                <div class="main-content" style="border-radius: 10px;padding: 20px;">
                    ...
                    <nav>
                        <ul class="pagination" style="float: right;">
                          ...
                          <?php endif; if(($curPage > 3) AND ($curPage < $totalPage-2)): $__FOR_START_11532__=$curPage-2;$__FOR_END_11532__=$curPage+3;for($i=$__FOR_START_11532__;$i < $__FOR_END_11532__;$i+=1){ ?>
                              <li><a <?php if($i==$curPage) echo "class='active'"; ?> href="<?php echo url('/index/TeachingOfficeTutor/tutor_change/page/'.$i); ?>" ><?php echo $i; ?></a></li>
                            <?php } elseif(($curPage > $totalPage-3) AND ($totalPage > 5)): $__FOR_START_28735__=$totalPage-5;$__FOR_END_28735__=$totalPage;for($i=$__FOR_START_28735__;$i < $__FOR_END_28735__;$i+=1){ ?>
                              <li><a <?php if($i==$curPage) echo "class='active'"; ?> href="<?php echo url('/index/TeachingOfficeTutor/tutor_change/page/'.$i); ?>" ><?php echo $i; ?></a></li>
                            <?php } elseif($totalPage > 5): $__FOR_START_17502__=1;$__FOR_END_17502__=6;for($i=$__FOR_START_17502__;$i < $__FOR_END_17502__;$i+=1){ ?>
                              <li><a <?php if($i==$curPage) echo "class='active'"; ?> href="<?php echo url('/index/TeachingOfficeTutor/tutor_change/page/'.$i); ?>" ><?php echo $i; ?></a></li>
                            <?php } else: $__FOR_START_27033__=1;$__FOR_END_27033__=$totalPage;for($i=$__FOR_START_27033__;$i < $__FOR_END_27033__;$i+=1){ ?>
                              <li><a <?php if($i==$curPage) echo "class='active'"; ?> href="<?php echo url('/index/TeachingOfficeTutor/tutor_change/page/'.$i); ?>" ><?php echo $i; ?></a></li>
