<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:74:"C:\wamp64\www\tutorAssign\public/../app/index\view\student\tutor_list.html";i:1479485623;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
                ...
                <div class="table-responsive">
                    ...
                    <nav>
                      <ul class="pagination" style="float: right;">
                          ...
                          <?php endif; if(($curPage > 3) AND ($curPage < $totalPage-2)): $__FOR_START_2975__=$curPage-2;$__FOR_END_2975__=$curPage+3;for($i=$__FOR_START_2975__;$i < $__FOR_END_2975__;$i+=1){ ?>
                              <li><a <?php if($i==$curPage) echo "class='active'"; ?> href="<?php echo url('/index/index/Student/tutor_list/page/'.$i); ?>" ><?php echo $i; ?></a></li>
                            <?php } elseif(($curPage > $totalPage-3) AND ($totalPage > 5)): $__FOR_START_12606__=$totalPage-5;$__FOR_END_12606__=$totalPage;for($i=$__FOR_START_12606__;$i < $__FOR_END_12606__;$i+=1){ ?>
                              <li><a <?php if($i==$curPage) echo "class='active'"; ?> href="<?php echo url('/index/index/Student/tutor_list/page/'.$i); ?>" ><?php echo $i; ?></a></li>
                            <?php } elseif($totalPage > 5): $__FOR_START_32249__=1;$__FOR_END_32249__=6;for($i=$__FOR_START_32249__;$i < $__FOR_END_32249__;$i+=1){ ?>
                              <li><a <?php if($i==$curPage) echo "class='active'"; ?> href="<?php echo url('/index/index/Student/tutor_list/page/'.$i); ?>" ><?php echo $i; ?></a></li>
                            <?php } else: $__FOR_START_27840__=1;$__FOR_END_27840__=$totalPage;for($i=$__FOR_START_27840__;$i < $__FOR_END_27840__;$i+=1){ ?>
                              <li><a <?php if($i==$curPage) echo "class='active'"; ?> href="<?php echo url('/index/index/Student/tutor_list/page/'.$i); ?>" ><?php echo $i; ?></a></li>
