<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:115:"/Applications/MAMP/htdocs/2/Tutor-distribution/tutorAssign/public/../app/index/view/teacher_tutor/student_list.html";i:1479391140;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
                ...
                <div class="table-responsive">
                    ...
                    <nav>
                      ...
                      <a href="<?php echo url('/index/index/TeacherTutor/student_list/'.($curPage-1)); ?>">&laquo;</a>
                          ...
                          <?php endif; if(($curPage > 3) AND ($curPage < $totalPage-2)): $__FOR_START_315124628__=$curPage-2;$__FOR_END_315124628__=$curPage+3;for($i=$__FOR_START_315124628__;$i < $__FOR_END_315124628__;$i+=1){ ?>
                              <li><a <?php if($i==$curPage) echo "class='active'"; ?> href="<?php echo url('/index/TeacherTutor/student_list/page/'.$i); ?>" ><?php echo $i; ?></a></li>
                            <?php } elseif(($curPage > $totalPage-3) AND ($totalPage > 5)): $__FOR_START_429519816__=$totalPage-5;$__FOR_END_429519816__=$totalPage;for($i=$__FOR_START_429519816__;$i < $__FOR_END_429519816__;$i+=1){ ?>
                              <li><a <?php if($i==$curPage) echo "class='active'"; ?> href="<?php echo url('index/TeacherTutor/student_list/page/'.$i); ?>" ><?php echo $i; ?></a></li>
                            <?php } elseif($totalPage > 5): $__FOR_START_1539591847__=1;$__FOR_END_1539591847__=6;for($i=$__FOR_START_1539591847__;$i < $__FOR_END_1539591847__;$i+=1){ ?>
                              <li><a <?php if($i==$curPage) echo "class='active'"; ?> href="<?php echo url('/index/TeacherTutor/student_list/page/'.$i); ?>" ><?php echo $i; ?></a></li>
                            <?php } else: $__FOR_START_1678932065__=1;$__FOR_END_1678932065__=$totalPage;for($i=$__FOR_START_1678932065__;$i < $__FOR_END_1678932065__;$i+=1){ ?>
                              <li><a <?php if($i==$curPage) echo "class='active'"; ?> href="<?php echo url('/index/TeacherTutor/student_list/page/'.$i); ?>" ><?php echo $i; ?></a></li>
