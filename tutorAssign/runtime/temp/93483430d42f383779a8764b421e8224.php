<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:101:"D:\wamp64\www\Tutor-distribution\tutorAssign\public/../app/index\view\teacher_tutor\issue_submit.html";i:1481701538;}*/ ?>
 <!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
        ...
        <div class="page-content">
            <div class="main-content" style="border-radius: 10px;padding: 20px;">
                <div role="alert" class="alert alert-info" style="margin-bottom: 0">
                    ...
                    <?php if(isset($message1)) {?><p>提示2：<?php echo $message1; ?></p><?php }if(isset($message2)) {?><p>提示3：<?php echo $message2; ?></p><?php }?>
                </div>
                <?php if($ontime == 0) { ?>
                         ...
                         <div class="form-group">
                             <div class="row" style ="margin:5px auto;">
                                 ...
                                 <div class="col-sm-2" style="width:120px">
                                     <select  class="form-control" name="totalNatur" <?php if($voluntaryinfosetting['department']=="计算机实验班"||$voluntaryinfosetting['department']=="数学实验班") { ?> disabled="disabled" <?php }?> >
                                 ...
                                 <div class="col-sm-2" style="width:120px">
                                     <select class="form-control" name="totalCompExper" <?php if($voluntaryinfosetting['department']!="计算机实验班") { ?> disabled="disabled" <?php }?> >
                                 ...
                                 <div class="col-sm-2" style="width:120px">
                                     <select class="form-control" name="totalMathExper" <?php if($voluntaryinfosetting['department']!="数学实验班") { ?> disabled="disabled" <?php }?> >
