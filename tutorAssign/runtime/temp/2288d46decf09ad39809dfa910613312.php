<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:94:"D:\wamp64\www\Tutor-distribution\tutorAssign\public/../app/index\view\teacher_tutor\index.html";i:1478505666;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
    ...
    <div id="siderbar">
        <nav class="sider-navbar">
            ...
            <ul class="sider-navbar-nav">
                ...
                <li><i class="glyphicon glyphicon-th-list"></i> 可选学生</li>
                <li><i class="glyphicon glyphicon-pencil"></i> 课题提交</li>
