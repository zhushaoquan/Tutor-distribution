...
<!-- 导入文件弹出框 -->
<div class="modal fade" id="exportExcelModal" tabindex="-1" role="dialog" aria-labelledby="exportExcelLabel"
     aria-hidden="true">
...
<script>
    ...
    function loadTabData(page) {
        $.ajax({
            ...
            url: "http://localhost/Tutor-distribution/tutorAssign/public/index.php/index/DepartmentHeadTutor/studentList",
            success: function (data) {
                vm.datas = data.information;
