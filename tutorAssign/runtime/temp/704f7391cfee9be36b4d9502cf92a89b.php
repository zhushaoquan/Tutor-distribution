<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:92:"C:\wamp64\www\tutorAssign\public/../app/index\view\teaching_office_tutor\student_assign.html";i:1479481311;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
                ...
                <div class="table-responsive">
                    ...
                    <nav>
                        <ul class="pagination" style="float: right;">
                          ...
                          <?php endif; if(($curPage > 3) AND ($curPage < $totalPage-2)): $__FOR_START_28516__=$curPage-2;$__FOR_END_28516__=$curPage+3;for($i=$__FOR_START_28516__;$i < $__FOR_END_28516__;$i+=1){ ?>
                            ...
                            <?php } elseif(($curPage > $totalPage-3) AND ($totalPage > 5)): $__FOR_START_25847__=$totalPage-5;$__FOR_END_25847__=$totalPage;for($i=$__FOR_START_25847__;$i < $__FOR_END_25847__;$i+=1){ ?>
                              <li><a <?php if($i==$curPage) echo "class='active'"; ?> href="<?php echo url('/index/TeachingOfficeTutor/student_assign/page/'.$i.'/dep/'.$dep); ?>" ><?php echo $i; ?></a></li>
                            <?php } elseif($totalPage > 5): $__FOR_START_14582__=1;$__FOR_END_14582__=6;for($i=$__FOR_START_14582__;$i < $__FOR_END_14582__;$i+=1){ ?>
                              <li><a <?php if($i==$curPage) echo "class='active'"; ?> href="<?php echo url('/index/TeachingOfficeTutor/student_assign/page/'.$i.'/dep/'.$dep); ?>" ><?php echo $i; ?></a></li>
                            <?php } else: $__FOR_START_29073__=1;$__FOR_END_29073__=$totalPage;for($i=$__FOR_START_29073__;$i < $__FOR_END_29073__;$i+=1){ ?>
                              <li><a <?php if($i==$curPage) echo "class='active'"; ?> href="<?php echo url('/index/TeachingOfficeTutor/student_assign/page/'.$i.'/dep/'.$dep); ?>" ><?php echo $i; ?></a></li>
