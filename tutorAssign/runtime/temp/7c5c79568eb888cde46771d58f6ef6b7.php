<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:111:"C:\wamp64\www\Tutor-distribution\tutorAssign\public/../app/index\view\teaching_office_tutor\student_assign.html";i:1481544514;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
                ...
                <!-- <div class="table-responsive"> -->
                    ...
                    <nav>
                        <ul class="pagination" style="float: right;">
                          ...
                          <?php endif; if(($curPage > 3) AND ($curPage < $totalPage-2)): $__FOR_START_24012__=$curPage-2;$__FOR_END_24012__=$curPage+3;for($i=$__FOR_START_24012__;$i < $__FOR_END_24012__;$i+=1){ ?>
                            ...
                            <?php } elseif(($curPage > $totalPage-3) AND ($totalPage > 5)): $__FOR_START_27647__=$totalPage-5;$__FOR_END_27647__=$totalPage;for($i=$__FOR_START_27647__;$i < $__FOR_END_27647__;$i+=1){ ?>
                              <li><a <?php if($i==$curPage) echo "class='active'"; ?> href="<?php echo url('/index/TeachingOfficeTutor/student_assign/page/'.$i.'/dep/'.$dep.'/grade/'.$grade); ?>" ><?php echo $i; ?></a></li>
                            <?php } elseif($totalPage > 5): $__FOR_START_22302__=1;$__FOR_END_22302__=6;for($i=$__FOR_START_22302__;$i < $__FOR_END_22302__;$i+=1){ ?>
                              <li><a <?php if($i==$curPage) echo "class='active'"; ?> href="<?php echo url('/index/TeachingOfficeTutor/student_assign/page/'.$i.'/dep/'.$dep.'/grade/'.$grade); ?>" ><?php echo $i; ?></a></li>
                            <?php } else: $__FOR_START_3929__=1;$__FOR_END_3929__=$totalPage;for($i=$__FOR_START_3929__;$i < $__FOR_END_3929__;$i+=1){ ?>
                              <li><a <?php if($i==$curPage) echo "class='active'"; ?> href="<?php echo url('/index/TeachingOfficeTutor/student_assign/page/'.$i.'/dep/'.$dep.'/grade/'.$grade); ?>" ><?php echo $i; ?></a></li>
