<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:91:"C:\wamp64\www\tutorAssign\public/../app/index\view\department_head_tutor\assign_result.html";i:1479483545;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
        ...
        <div id="siderbar">
            <nav class="sider-navbar">
                ...
                <ul class="sider-navbar-nav">
                    <a href="/tutorAssign/public/index/DepartmentHeadTutor/index.html">
                    ...
                    <a href="/tutorAssign/public/index/DepartmentHeadTutor/timeSetting.html">
                        <li><i class="glyphicon glyphicon-time"></i> 时间设置</li>
                    </a>
                    <a href="/tutorAssign/public/index/DepartmentHeadTutor/matchSetting.html">
                        <li class="active"><i class="glyphicon glyphicon-resize-small"></i> 匹配设置</li>
                    </a>
                    ...
                    <div class="table-position" style="width: 90%; margin: 0 auto;">
                        <table class="table table-hover">
                            ...
                            <?php if(is_array($studentElectedResult) || $studentElectedResult instanceof \think\Collection): $i = 0; $__LIST__ = $studentElectedResult;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$r): $mod = ($i % 2 );++$i;?>
                                <tr>
                                    <td><?php echo $i; ?></td>
                                    <td><?php echo $r['serialNum']; ?></td>
                                    <td><?php echo $r['sname']['name']; ?></td>
                                    <td><?php echo $r['tname']['name']; ?></td>
                                </tr>
                                <?php endforeach; endif; else: echo "" ;endif; ?>
                            </tbody>
                        </table>
                        <div class="submit-area">
                            <a href="" class="btn btn-info button-size" id="sub-result-export">确&nbsp;&nbsp;认</a>
                        </div>
