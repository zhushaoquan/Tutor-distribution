<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:124:"/Applications/MAMP/htdocs/2/Tutor-distribution/tutorAssign/public/../app/index/view/department_head_tutor/match_setting.html";i:1479299084;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
                ...
                <div class="table-position">
                    ...
                    <nav>
                      <ul class="pagination" style="float: right;">
                          ...
                          <?php endif; if(($curPage > 3) AND ($curPage < $totalPage-2)): $__FOR_START_1590258535__=$curPage-2;$__FOR_END_1590258535__=$curPage+3;for($i=$__FOR_START_1590258535__;$i < $__FOR_END_1590258535__;$i+=1){ ?>
                            ...
                            <?php } elseif(($curPage > $totalPage-3) AND ($totalPage > 5)): $__FOR_START_1379815233__=$totalPage-5;$__FOR_END_1379815233__=$totalPage;for($i=$__FOR_START_1379815233__;$i < $__FOR_END_1379815233__;$i+=1){ ?>
                              <li><a <?php if($i==$curPage) echo "class='active'"; ?> href="<?php echo url('/index/index/DepartmentHeadTutor/matchSetting/page/'.$i); ?>" ><?php echo $i; ?></a></li>
                            <?php } elseif($totalPage > 5): $__FOR_START_56337839__=1;$__FOR_END_56337839__=6;for($i=$__FOR_START_56337839__;$i < $__FOR_END_56337839__;$i+=1){ ?>
                              <li><a <?php if($i==$curPage) echo "class='active'"; ?> href="<?php echo url('/index/index/DepartmentHeadTutor/matchSetting/page/'.$i); ?>" ><?php echo $i; ?></a></li>
                            <?php } else: $__FOR_START_1747282460__=1;$__FOR_END_1747282460__=$totalPage;for($i=$__FOR_START_1747282460__;$i < $__FOR_END_1747282460__;$i+=1){ ?>
                              <li><a <?php if($i==$curPage) echo "class='active'"; ?> href="<?php echo url('/index/index/DepartmentHeadTutor/matchSetting/page/'.$i); ?>" ><?php echo $i; ?></a></li>
                ...
                <div class="table-position-popup">
                    ...
                    <!-- <nav>
                      <ul class="pagination" style="float: right;">
                          ...
                          <?php endif; if(($teacherCurPage > 3) AND ($teacherCurPage < $teacherTotalPage-2)): $__FOR_START_1036888998__=$teacherCurPage-2;$__FOR_END_1036888998__=$teacherCurPage+3;for($i=$__FOR_START_1036888998__;$i < $__FOR_END_1036888998__;$i+=1){ ?>
                            ...
                            <?php } elseif(($teacherCurPage > $teacherTotalPage-3) AND ($teacherTotalPage > 5)): $__FOR_START_1282340422__=$teacherTotalPage-5;$__FOR_END_1282340422__=$teacherTotalPage;for($i=$__FOR_START_1282340422__;$i < $__FOR_END_1282340422__;$i+=1){ ?>
                              <li><a <?php if($i==$teacherCurPage) echo "class='active'"; ?> href="<?php echo url('/index/index/DepartmentHeadTutor/matchSetting/page/'.$i); ?>" ><?php echo $i; ?></a></li>
                            <?php } elseif($teacherTotalPage > 5): $__FOR_START_227792575__=1;$__FOR_END_227792575__=6;for($i=$__FOR_START_227792575__;$i < $__FOR_END_227792575__;$i+=1){ ?>
                              <li><a <?php if($i==$teacherCurPage) echo "class='active'"; ?> href="<?php echo url('/index/index/DepartmentHeadTutor/matchSetting/page/'.$i); ?>" ><?php echo $i; ?></a></li>
                            <?php } else: $__FOR_START_1221404011__=1;$__FOR_END_1221404011__=$teacherTotalPage;for($i=$__FOR_START_1221404011__;$i < $__FOR_END_1221404011__;$i+=1){ ?>
                              <li><a <?php if($i==$teacherCurPage) echo "class='active'"; ?> href="<?php echo url('/index/index/DepartmentHeadTutor/matchSetting/page/'.$i); ?>" ><?php echo $i; ?></a></li>
                            <?php } endif; ?>
                        <li><a href="#">&raquo;</a></li>
