...
class TeacherTutor extends BaseController {
    ...
    public function showNotice($str, $smartMode) {
        ...
        $data['info'] = $str;
        $data['url'] = $smartMode;
    echo '<script type="text/javascript" src="__STATIC__/js/index.js"></script>';
    echo '<script type="text/javascript" src="__STATIC__/js/jquery2.14.min.js"></script>';
    echo '<script type="text/javascript" src="__STATIC__/js/bootstrap.js"></script>';
    echo '<script type="text/javascript" src="__STATIC__/js/backstage.js"></script>';
      ...
      return json($data);
        ...
        echo '<script>window.alert = function(str)
{
